 ...
 */
@WebServlet(name = "RejeitarPreInscricao", urlPatterns = {"/RejeitarPreInscricao"})
public class RejeitarPreInscricao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                message.setText("A sua Pre-Inscricao Nao foi Aceite!");
            ...
            try {
                estudanteController.destroy(idEstudante);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RejeitarPreInscricao</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RejeitarPreInscricao at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
