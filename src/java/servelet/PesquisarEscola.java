 ...
 */
@WebServlet(name = "PesquisarEscola", urlPatterns = {"/PesquisarEscola"})
public class PesquisarEscola extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Escola> escolaList = escolaController.buscarEscola(atributo);
            request.setAttribute("escolas", escolaList);
            if(tipo==0){
